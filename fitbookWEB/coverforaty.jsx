...
const Cover = React.createClass({
  ...
  handleInOrOut(isin){
    ...
    var url="http://127.0.0.1:8888/fitbook/atyinandout.php?ssid=";
    url+=getCookie("ssid");
    url+="&atyid=";
  ...
  atychange(){
    ...
    var url="http://127.0.0.1:8888/fitbook/atychanger.php?ssid=";
    url+=getCookie("ssid");
    url+="&coin=";
    url+=coin;
    url+="&title=";
  ...
  handleDelete(){
    ...
    var url="http://127.0.0.1:8888/fitbook/atydeleter.php?atyid=";
    url+=this.state.atyid;
    url+="&ssid=";
    url+=getCookie("ssid");
  ...
  initData(){
    ...
    var url="http://127.0.0.1:8888/fitbook/atyinfogetter.php?atyid=";
    url+=this.state.atyid;
    url+="&ssid=";
    url+=getCookie("ssid");
