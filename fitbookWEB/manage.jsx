...
const Stat = React.createClass({
  ...
  handleDelete(){
    ...
    if(this.state.delpara.substring(0,1)=='u'){
      ...
      var url="http://127.0.0.1:8888/fitbook/fastuserdeleter.php?username=";
      url+=realname;
      ...
      var url="http://127.0.0.1:8888/fitbook/fastatydeleter.php?atyid=";
      url+=realname;
  ...
  initData(){
    ...
    var url="http://127.0.0.1:8888/fitbook/search.php?keyword=";
    url+="@@";
