...
const GroupRight = React.createClass({
  ...
  invite(){
    ...
    var url="http://127.0.0.1:8888/fitbook/atyinviter.php?ssid=";
    url+=getCookie("ssid");
    url+="&atyid=";
  ...
  handleDialogOpen(){
    ...
    var url="http://127.0.0.1:8888/fitbook/atycandidate.php?ssid=";
    url+=getCookie("ssid");
    url+="&atyid=";
    url+=this.state.atyid;
  ...
  initData(){
    ...
    var url="http://127.0.0.1:8888/fitbook/atyrightgetter.php?ssid=";
    url+=getCookie("ssid");
    url+="&atyid=";
    url+=this.state.atyid;
